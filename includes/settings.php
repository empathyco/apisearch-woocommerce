...
function render_apisearch_settings_page()
{
    ...
    if ($permalink_structure && $permalink_structure !== '') {
        $feed_url = site_url('/wp-json/apisearch/feed');
        $pathInUrl = false;
    } else {
        $feed_url = site_url('/?rest_route=/apisearch/feed/');
        $pathInUrl = true;
    }

//    //todo: temporary not using auth token, so hide from url
//
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <label for="show_search_input">
                            <input type="checkbox" name="show_search_input" id="show_search_input"
                                   value="1" <?php checked(get_option('show_search_input'), 1); ?>>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="index_id" id="index_id"
                               value="<?php echo esc_attr(get_option('index_id')); ?>" class="regular-text">
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    ...
                    <td>
                        <label for="index_product_without_image">
                            <input type="checkbox" name="index_product_without_image" id="index_product_without_image"
                                   value="1" <?php checked(get_option('index_product_without_image'), 1); ?>>
                            Enable
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label for="index_product_purchase_count">
                            <input type="checkbox" name="index_product_purchase_count" id="index_product_purchase_count"
                                   value="1" <?php checked(get_option('index_product_purchase_count'), 1); ?>>
                            Enable
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label for="index_non_available_products">
                            <input type="checkbox" name="index_non_available_products" id="index_non_available_products"
                                   value="1" <?php checked(get_option('index_non_available_products'), 1); ?>>
                            Enable
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label for="index_supplier_references">
                            <input type="checkbox" name="index_supplier_references" id="index_supplier_references"
                                   value="1" <?php checked(get_option('index_supplier_references'), 1); ?>>
                            Enable
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label for="index_short_descriptions">
                            <input type="checkbox" name="index_short_descriptions" id="index_short_descriptions"
                                   value="1" <?php checked(get_option('index_short_descriptions'), 1); ?>>
                            Enable
                        </label>
                    </td>
                </tr>
...
<!--                                <td>-->
<!--                                    <input type="text" name="uuid_auth_token" id="uuid_auth_token" value="-->
<!--            --><?php //echo esc_attr(get_option('uuid_auth_token')); ?><!--" class="regular-text" readonly>-->
...
<!--                        </table>-->
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="feed_url" id="feed_url" value="<?php echo esc_attr($feed_url); ?>"
                               class="regular-text" readonly>
                        <button class="button button-secondary" id="copy_to_clipboard" type="button">
                            <i class="dashicons dashicons-admin-page" style="padding: 4px 4px 4px 0;"></i> Copy to
                            Clipboard
                        </button>
                    </td>
                </tr>
